...
<html class="no-js">
    ...
    <head>
        ...
        <link href="{{ asset('template/vendors/easypiechart/jquery.easy-pie-chart.css') }}" rel="stylesheet" media="screen">
    ...
    <body>
            ...
            <div class="row-fluid">
                <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        <li class="active">
                            <a href="{{ url('/index') }}"><i class="icon-chevron-right"></i> Dashboard</a>
                        </li>
                        <li>
        ...
        <script src="{{ asset('template/vendors/easypiechart/jquery.easy-pie-chart.js') }}"></script>
